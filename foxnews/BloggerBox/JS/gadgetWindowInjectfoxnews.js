// Append required stuff to document
    ...
    bloggerBoxCSS.setAttribute("href", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/CSS/bloggerBox.css");
    ...
    jScrollCSS.setAttribute("href", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/CSS/jScrollPane.css");
    ...
    mWheelScript.setAttribute("src", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/JS/jMouseWheel.js");
    ...
    jScrollScript.setAttribute("src", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/JS/jScrollPane-1.2.3.js");
    ...
    bloggerBoxScript.setAttribute("src", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/JS/bloggerBox2.js");
    ...
    {
        $('.contentBox').append('<div id="footerBG"><div class="footer"><a href="http://www.conduit.com#_tab"><span class="AppPowered">App powered by</span><img id="conduitLogo" src="http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/Images/conduit.png" /></a></div></div>');
    }
   ...
   */
   ...
   // New Footer Handler
   {
        $('#footerBG').css('height', '26px').css('width', '460px');
   }
