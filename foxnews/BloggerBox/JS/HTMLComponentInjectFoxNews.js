// Append required stuff to document
    ...
    bloggerBoxBtnCSS.setAttribute("href", "http://cap1.conduit-apps.com/Apps/BlogApps/BloggerBox/CSS/bloggerBoxBtnfn.css");
    ...
    $(document).click(function(){
       LaunchGadget(ConduitHTMLComponent.GadgetWindow.GWURL, parseInt(ConduitHTMLComponent.GadgetWindow.GWWidth), realHeight, 'resizable=no,hscroll=no,vscroll=no,titlebar=yes,closeonexternalclick=no,closebutton=yes,savelocation=no,saveresizedsize=no,openposition=alignment:(B;L)'); 
    });
