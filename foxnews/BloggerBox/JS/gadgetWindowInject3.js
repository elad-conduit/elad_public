// Append required stuff to document
    ...
    bloggerBoxCSS.setAttribute("href", "http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/CSS/bloggerBox.css");
    ...
    jScrollCSS.setAttribute("href", "http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/CSS/jScrollPane.css");
    ...
    mWheelScript.setAttribute("src", "http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/JS/jMouseWheel.js");
    ...
    jScrollScript.setAttribute("src", "http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/JS/jScrollPane-1.2.3.js");
    ...
    bloggerBoxScript.setAttribute("src", "http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/JS/bloggerBox3.js");
    ...
    $(".contentBox").append('<p style="margin-bottom: 3px; height: 98px;">  <a href="' + ConduitGadgetWindow.webURL + '#_tab"> <img class="logo" src="' + ConduitGadgetWindow.Logo + '"/> </a> <img id="close" class="closeCI" src="' + ConduitGadgetWindow.closeBTN + '" /> </p>');
    ...
    {
        $('.contentBox').append('<div id="footerBG"><div class="footer"><a href="http://www.conduit.com#_tab"><span class="AppPowered">App powered by</span><img id="conduitLogo" src="http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/Images/conduit.png" /></a></div></div>');
    }
   ...
   */
   ...
   // New Footer Handler
   {
        $('#footerBG').css('height', '26px').css('width', '455px').css('background-image', 'url(' + 'http://ec2-75-101-207-56.compute-1.amazonaws.com/BloggerBox/Images/bg_opacity.png' + ')').css('margin-top','1px').css('margin-left','1px');
   }
