...
var cwdObject =
{
	...
	document.getElementsByTagName('body').item(0).appendChild(ifrObj);
        ...
        _gaq.push(['_trackEvent', '<?php print $dynamicDetails["publisher"]?>', 'Install', gaOptions]);
    ...
    */
    ...
    _gaq.push(['_trackEvent', '<?php print $dynamicDetails["publisher"]?>', 'View', '<?php print $dynamicDetails["gaTitle"] ?>']);
