$(document).ready(function() {
    var cookiename = "euroleaguewhatsapp.conduit";
    
    var SERVER_PREFIX = "http://ec2-67-202-51-198.compute-1.amazonaws.com/euroleague/";
    ...
    function pollDigg()
    {
        ...
        $.ajax({
            url: "checkFeed.php",
            data: "url=http://www.euroleague.net/rssfeed/27/180.xml&data=" + cookieContents,
